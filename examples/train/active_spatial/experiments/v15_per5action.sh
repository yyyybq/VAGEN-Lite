# v15: Per-5-Action 对照实验（致敬老 v8/v9），基于 v11 框架
#
# ============================================================
# 实验目的
# ============================================================
...
cd /scratch/by2593/project/Active_Spatial/VAGEN-Lite && \
  nohup bash examples/train/active_spatial/run_experiment.sh \
    examples/train/active_spatial/experiments/v15_per5action.sh \
    > v15_per5action_v2.log 2>&1 &
echo "PID: $!"
RUN

EXPERIMENT_NAME="v15_per5action_v2"  # _v2 suffix: fresh run after reward-shaping rebalance (potential 1->5, vis 0.3->0.05, success 1->5) + critic_warmup 40->10. Old wandb run preserved.
ENV_CONFIG="env_config_5action_256.yaml"   # ★ per-5-action，奖励尺度匹配老 v9
NUM_TRAIN_GPUS=4
RENDERING_GPU=4

RESUME_MODE="auto"  # auto-resume from latest checkpoint (e.g. global_step_80) after OSError fix

# === 继承 v11 稳定性参数（与 v11 完全一致）===
ENTROPY_COEFF="0.008"
USE_KL_LOSS="True"
KL_LOSS_COEF="0.015"
TEMPERATURE="0.9"
...
MAX_TURNS=10               # ★ 50 → 10：10 turns × 5 action/turn = 50 总动作
WINDOW_SIZE=1
MAX_TRAJECTORY_LENGTH=16000  # ★ 28000 → 16000：10 turns × ~1200tok/turn ≈ 12000
MAX_RESPONSE_LENGTH=512    # per-5-action 输出较长，保留 512
MAX_PROMPT_LENGTH=2048
