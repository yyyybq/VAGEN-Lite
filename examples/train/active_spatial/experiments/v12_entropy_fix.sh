# v12: 修复 entropy 爆炸 + GPU OOM（继承 v11 核心修复）
#
# ============================================================
...
cd /scratch/by2593/project/Active_Spatial/VAGEN-Lite && \
  nohup bash examples/train/active_spatial/run_experiment.sh \
    examples/train/active_spatial/experiments/v12_entropy_fix.sh \
    > v12_entropy_fix.log 2>&1 &
echo "PID: $!"
RUN

EXPERIMENT_NAME="v12_entropy_fix"
ENV_CONFIG="env_config_single_action_256.yaml"
NUM_TRAIN_GPUS=4
RENDERING_GPU=4
