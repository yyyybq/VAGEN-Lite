...
cd /scratch/by2593/project/Active_Spatial/VAGEN-Lite && \
  nohup bash examples/train/active_spatial/run_experiment.sh \
    examples/train/active_spatial/experiments/v15_per5action_v3_test.sh \
    > v15_per5action_v3_test.log 2>&1 &
echo "PID: $!"
RUN

EXPERIMENT_NAME="v15_per5action_v3_test"  # _v3_test: 修复 episode 提前终止 bug（gym_agent_loop_no_concat.py）
